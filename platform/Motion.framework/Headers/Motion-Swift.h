...
SWIFT_CLASS("_TtC6Motion16MotionController")
...
@interface Motion (SWIFT_EXTENSION(Motion)) <UINavigationControllerDelegate>
...
@interface Motion (SWIFT_EXTENSION(Motion)) <UITabBarControllerDelegate>
...
@interface Motion (SWIFT_EXTENSION(Motion)) <UIViewControllerInteractiveTransitioning>
...
@interface Motion (SWIFT_EXTENSION(Motion)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC6Motion27MotionIndependentController")
...
SWIFT_CLASS("_TtC6Motion12MotionPlugin")
